...
def ahorcado ():
    ...
    while len(letras_por_adivinar) > 0 and vidas > 0:
        ...
        # Si la letra escogida por el usuario está en el abecedario y no está en el conjunto de letras que
        # ya se han ingresado, se añade la letra al conjunto de letras ingresadas.
        ...
        # Si la letra escogida por el usuario ya fue ingresada.        
            ...
            print("\nEsta letra no es váliad.")

    if vidas == 0:
        print(vidas_diccionario_visual[vidas])
        print("¡Ahorcado! Perdiste. Lo lamento mucho. La palabra era: {palabra}")
    else: 
